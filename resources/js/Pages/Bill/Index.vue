    ...
    <a-layout-content>
      <a-space direction="vertical" :style="{ width: '100%' }">
        <a-form name="nest-messages" :model="searchform" layout="inline" @finish="search">
          <a-form-item>
            <a-input placeholder="Search by Bill Number" :allow-clear="true" v-model:value="searchform.term">
            </a-input>
          </a-form-item>
          <a-form-item>
      ...
      <a-drawer v-model:visible="create_form_visible" class="sales-bill" :size="'large'" style="color: red;" width="60%"
        title="New Bill" placement="right" @after-visible-change="afterVisibleChange">
        <a-form :model="form" v-bind="layout" name="nest-messages" :validate-messages="validateMessages" @finish="submit"
          ...
          <a-row :gutter="24">
            ...
            <a-col class="gutter-row" span="8">
              <a-form-item name="name" label="Bill Number" :rules="[{ required: true }]">
                <a-input v-model:value="form.name" />
              </a-form-item>
            </a-col>
            <a-col class="gutter-row" span="8">
              <a-form-item name="name" label="Order Number">
                <a-input v-model:value="form.name" />
              </a-form-item>
            </a-col>
            <a-col class="gutter-row" span="8">
              <a-form-item name="name" label="Bill Date" :rules="[{ required: true }]">
                <a-input v-model:value="form.name" />
              </a-form-item>
            </a-col>
            <a-col class="gutter-row" span="8">
              <a-form-item name="name" label="Due Date">
                <a-input v-model:value="form.name" />
              </a-form-item>
            </a-col>
            <a-col class="gutter-row" span="8">
          ...
          <a-table :columns="billcolumns" :data-source="createPurchaseOrderItems" :pagination="false">
            <template #bodyCell="{ column, record }">
      ...
      <a-drawer v-model:visible="showdetail" class="custom-class" title="PO-000001" :size="'large'" placement="right"
        ...
        <a-space style="margin-bottom: 10px;">
          ...
          <a-button @click="onClose">
            <PlusOutlined /> Add Payment Record
          </a-button>
          <a-button @click="onClose">
        ...
        <div class="quote-template">
          <table style="width:100%" class="quote-table">
            ...
            <tr class="highlight">
              <td colspan="2">
                <p>Bill Number : PO-000001</p>
                <p>Bill Date : 10/10/2023</p>
                <p>Due Date : 10/10/2023</p>
              </td>
              <td colspan="2" align="right">
                <h4>INR 54000.00</h4>
                <p><small>BALANCE DUE</small></p>
              </td>
            </tr>
            <tr>
              <td colspan="2">
            ...
            <tr>
              <td colspan="2">
                <div style="margin-right:20px">
                  ...
                  <p>1. Payment should be made within 30 days from the date of bill.</p>
...
//adding 5 more data with different bill_number and vendor_name
{
  key: '2',
  date: '10-10-2023',
...
// defining create bill items const
