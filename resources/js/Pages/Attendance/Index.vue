    ...
    <a-layout-content
      ...
      <a-space direction="vertical" :style="{ width: '100%' }">
        <a-form name="nest-messages" :model="formState" layout="inline" @finish="search">
          ...
          <a-form-item>
            <a href="/attendance/summaryreport" download="file.xlsx">
...
export default ({
  ...
  methods: {
    ...
    deletemanualrow(parentrecord, record) {
      ...
      if (this.employees[index1].history.length == 0) {
        const index = this.showmanualsave.indexOf(parentrecord.employee_id);
        if (index > -1) {
          this.showmanualsave.splice(index, 1);
        }
      }
    }
  }
