    ...
    <a-layout-content>
      <a-space direction="vertical" :style="{ width: '100%' }">
        <a-form name="nest-messages" :model="searchform" layout="inline" @finish="search">
          <a-form-item>
            <a-input placeholder="Search by Invoice Number" :allow-clear="true" v-model:value="searchform.term">
            </a-input>
          </a-form-item>
          <a-form-item>
      ...
      <a-drawer v-model:visible="create_form_visible" class="sales-bill" :size="'large'" style="color: red;"
        title="New Invoice" placement="right" @after-visible-change="afterVisibleChange">
        <a-form :model="form" v-bind="layout" name="nest-messages" :validate-messages="validateMessages" @finish="submit"
          ...
          <a-row :gutter="24">
            ...
            <a-col class="gutter-row" span="8">
              <a-form-item name="name" label="Invoice Number" :rules="[{ required: true }]">
            ...
            <a-col class="gutter-row" span="8">
              <a-form-item name="name" label="Invoice Date" :rules="[{ required: true }]">
                <a-input v-model:value="form.name" />
              </a-form-item>
            </a-col>
            <a-col class="gutter-row" span="8">
          ...
          <a-table :columns="invoicecolumns" :data-source="createInvoiceItems" :pagination="false">
            <template #bodyCell="{ column, record }">
      ...
      <a-drawer v-model:visible="showdetail" class="custom-class" title="QT-000001" :size="'large'" placement="right"
        ...
        <a-space style="margin-bottom: 10px;">
          ...
          <a-button @click="onClose"><PlusOutlined /> Record Payment</a-button>
          <a-button @click="onClose"><MailOutlined /> Send Invoice</a-button>
          <a-button @click="onClose"><CheckOutlined /> Mark As Sent</a-button>
        </a-space>
        <div class="quote-template">
          <table style="width:100%" class="quote-table">
            ...
            <tr class="highlight">
              <td colspan="2">
                <p>Invoice Number : QT-000001</p>
                <p>Invoice Date : 10/10/2023</p>
...
// defining create invoice items const
